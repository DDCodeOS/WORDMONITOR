...
| YouTube video metadata (deprecated) | `GET /api/aviation/v1/get-youtube-live-stream-info` | Names a YouTube video through oEmbed. Channel live detection is retired: a channel-only query returns error `channel_live_detection_retired`. Not part of the six-tab auto-refresh loop. |
